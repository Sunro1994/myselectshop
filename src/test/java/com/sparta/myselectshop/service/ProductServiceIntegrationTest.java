...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // 테스트 인스턴스의 생성 단위를 클래스로 변경합니다. 아래 필드로 생성한 클래스를 공유해서 사용가능!
@TestMethodOrder(MethodOrderer.OrderAnnotation.class) //Order대로 작동하도록 설정
